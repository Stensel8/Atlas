...
New-Shortcut -Source "$desktop\9. Troubleshooting\Set services to defaults.ps1" -Destination "$desktop\6. Advanced Configuration\Services\Set services to defaults.lnk"
