...
echo]
powershell -NoP -EP Bypass -File "%windir%\AtlasModules\Scripts\edgeCheck.ps1" -EdgeOnly
...
powershell -NoP -EP Bypass -File "%windir%\AtlasModules\Scripts\WingetCheck.ps1" -NoDashes
if %errorlevel% neq 0 exit /b 1
