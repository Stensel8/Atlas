...
Set-AtlasSettingState -SettingName 'VbsState' -State 1 -ScriptPath $PSCommandPath
...
Set-ItemProperty -LiteralPath $hvciKey -Name 'Enabled' -Value 1 -Type DWord
...
Set-ItemProperty -LiteralPath $dgKey -Name 'EnableVirtualizationBasedSecurity' -Value 1 -Type DWord
