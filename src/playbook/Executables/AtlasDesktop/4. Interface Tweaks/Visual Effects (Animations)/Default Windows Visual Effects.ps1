...
Set-AtlasSettingState -SettingName 'Animation' -State 1 -ScriptPath $PSCommandPath
...
Set-ItemProperty -LiteralPath $winMetrics -Name 'MinAnimate'             -Value '1'
New-ItemProperty -LiteralPath $desktop -Name 'UserPreferencesMask' `
    -Value ([byte[]](0x9E, 0x1E, 0x07, 0x80, 0x12, 0x00, 0x00, 0x00)) -PropertyType Binary -Force | Out-Null
...
New-ItemProperty -LiteralPath $adv -Name 'TaskbarAnimations'   -Value 1 -PropertyType DWord -Force | Out-Null
New-ItemProperty -LiteralPath $adv -Name 'ListviewShadow'      -Value 1 -PropertyType DWord -Force | Out-Null
New-ItemProperty -LiteralPath $vfx -Name 'VisualFXSetting'     -Value 0 -PropertyType DWord -Force | Out-Null
New-ItemProperty -LiteralPath $dwm -Name 'EnableAeroPeek'            -Value 1 -PropertyType DWord -Force | Out-Null
New-ItemProperty -LiteralPath $dwm -Name 'AlwaysHibernateThumbnails' -Value 1 -PropertyType DWord -Force | Out-Null
